...
$options = array(
	'id' => $this->id,
	'load_orders_url' => URL.'services/lists?view_stype=bucketed',
	'load_create_url' => URL.'services/create',
	'load_profile_url' => URL.'services/profile',
	'URL' => URL.'services/',
	// 'count' => $this->count
);
...
<div id="services" class="datalist-container" data-plugins="datalist" data-options="<?=$this->fn->stringify( $options )?>">
	...
	<div role="content" class="datalist-content has-empty">
		<div class="datalist-main-container" role="main">
			<div class="datalist-main" role="profile">
			</div>
