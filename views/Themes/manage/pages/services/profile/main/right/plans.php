...
$options = array(
	...
	'upcoming' => array(
		'url' => URL."events/upcoming?obj_type=services&obj_id={$this->item['id']}&invite=0&view_stype=bucketed&upcoming",
...
if( !empty($this->permit['services']['edit']) || $this->me['id'] == $this->item['emp']['id'] ){
	$options['add_url'] = URL."events/add?obj_type=services&obj_id={$this->item['id']}";
