	...
	<div ref="actions" class="listpage2-actions">
		...
		<ul class="lfloat" ref="title">
			<li class="anchor clearfix mg-anchor">
				<div class="lfloat mrm top-doc-logo"><?=!empty( $this->system['title'] ) ? $this->system['title']:'';?></div><div class="content"><div class="spacer"></div><div class="massages"><div class="fullname">บริการ</div></div></div>
			</li>
		</ul>
		...
		<ul class="lfloat" ref="actions">
			...
			<li><label for="closedate" class="label">Close date</label><select ref="closedate" name="closedate" class="inputtext">
