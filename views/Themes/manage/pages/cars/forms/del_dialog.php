...
if( $this->item['permit']['del'] ){
	...
	$arr['body'] = "คุณต้องการลบ <span class=\"fwb\">\"{$this->item['first_name']} {$this->item['last_name']}\"</span> หรือไม่?";
	...
	$arr['body'] = "คุณไม่สามารถลบ <span class=\"fwb\">\"{$this->item['first_name']} {$this->item['last_name']}\"</span> ได้?";	
