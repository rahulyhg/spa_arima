...
$form = $form->create()
    ->url( URL."cars/save")
    ->addClass('js-submit-form form-insert mal clearfix')
...
$a[] = array( 
    ...
    'value' => $this->item['cus_prefix_name_th']
);
...
echo '<div style="max-width: 620px;">'.$form->html().'</div>';