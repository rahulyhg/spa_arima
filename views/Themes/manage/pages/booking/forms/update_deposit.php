...
$form   ->field("book_type")
        ->text( 
'<ul class="list-table-cell" data-plugins="actionsListHiden">'.
    '<li data-active="cash"><label class="radio"><input'.( $deposit_type=='cash' ? ' checked="1"':'' ).' type="radio" name="book[deposit_type]" value="cash" data-actions="cash">เงินสด</label></li>'.
    '<li data-active="credit"><table>'.
        '<tr>'.
            '<td class="pts"><label class="radio"><input'.( $deposit_type=='credit' ? ' checked="1"':'' ).' type="radio" name="book[deposit_type]" value="credit" data-actions="credit" />บัตเครดิต</label></td>'.
    ...
    '<li data-active="check"><table>'.
        '<tr>'.
            '<td class="pts" style="width:100px"><label class="radio"><input type="radio" name="book[deposit_type]" value="check"'.( $deposit_type=='check' ? ' checked="1"':'' ).' data-actions="check"><span>เช็คธนาคาร</span></label></td>'.
