...
$options = array(
	...
	'upcoming' => array(
		'url' => URL."events/upcoming?obj_type=booking&obj_id={$this->item['id']}&invite=0&view_stype=bucketed&upcoming",
...
if( !empty($this->permit['booking']['edit']) || $this->me['id'] == $this->item['sale']['id'] ){
	$options['add_url'] = URL."events/add?obj_type=booking&obj_id={$this->item['id']}";
