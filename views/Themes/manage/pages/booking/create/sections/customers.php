...
$form   ->field("book_cus_refer")
        ...
        ->autocomplete('off')
        ->addClass('inputtext')
        ->select( $this->cus_refer, 'id', 'name', 0 );

$form   ->field("cus_name")
        ->label('ชื่อ')
        ->text( $this->fn->q('form')->fullname( !empty($this->item)?$this->item:array(), array('field_first_name'=>'cus[','field_last_name'=>']', 'prefix_name'=>$this->prefixName) ) );
