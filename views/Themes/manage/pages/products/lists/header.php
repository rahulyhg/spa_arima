<div ref="header" class="listpage2-header clearfix">
	...
	<div ref="actions" class="listpage2-actions">
		...
		<ul class="lfloat" ref="actions">
			...
			<li><a href="<?=URL?>products/create" class="btn btn-primary"><i class="icon-plus mrs"></i><span class="btn-text">Add New</span></a></li>
			<li><a href="<?=URL?>settings/models" class="btn"><span class="btn-text">Model</span></a></li>
