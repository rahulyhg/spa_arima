...
$options = array(
	...
	'upcoming' => array(
		'url' => URL."events/upcoming?obj_type=employees&obj_id={$this->item['id']}&invite=0&view_stype=bucketed&upcoming",
...
if( !empty($this->permit['sales']['edit']) || $this->me['id'] == $this->item['id'] )
{
	$options['add_url'] = URL."events/add?obj_type=employees&obj_id={$this->item['id']}";
...
<?php if( !empty($this->permit['sales']['edit']) || $this->me['id'] == $this->item['id'] ) { ?>
