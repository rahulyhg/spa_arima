...
<div class="rfloat">
	...
	<span class="gbtn"><a class="btn btn-blue" data-plugins="dialog" href="<?=$url?>add_skill"><i class="icon-plus mrs"></i><span>Add New</span></a></span>

</div>

<div class="setting-title">Skill</div>
</div>
