...
#customer
$cus[] = array('key'=>'customers','text'=>'ประวัติลูกค้า','link'=>$url.'customers','icon'=>'address-card-o');
echo $this->fn->manage_nav($cus, $this->getPage('on'));

#booking
$bok[] = array('key'=>'booking','text'=>'รายการจองรถยนต์','link'=>$url.'booking','icon'=>'address-book-o');
$bok[] = array('key'=>'stocks','text'=>'สต็อกรถยนต์','link'=>$url.'stocks','icon'=>'car');
...
#services
$sv[] = array('key'=>'sales','text'=>'Sales','link'=>$url.'sales','icon'=>'user-circle-o');
$sv[] = array('key'=>'services','text'=>'งานบริการ','link'=>$url.'services','icon'=>'handshake-o');
...
$cog[] = array('key'=>'settings','text'=>'การตั้งค่า','link'=>$url.'settings','icon'=>'cog');
