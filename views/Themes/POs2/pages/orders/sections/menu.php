<div style="position: absolute;top: 0;left: 0;right: 0;bottom: 0;overflow-y: hidden;">
		<div style="position: absolute;padding-top: 50px;padding-left: 30px;right: 18px;left: 0;background-color: rgba(0, 144, 195,.98);z-index: 5;max-width: 700px;">
		...
		<div class="ui-effect-top active" data-memu="package"><div class="memu-tab-content" style="padding-top: 100px;padding-bottom: 30px; padding-right: 30px">
			...
			<li class="ui-menu-item"><a class="inner clearfix"><div class="image" style=""><div class="gradient-overlay"></div></div><div class="text clearfix"><div class="title-block"><div class="category"></div><div class="title"><?=$value['name']?></div></div></div></a></li>
			<?php } ?></ul>
