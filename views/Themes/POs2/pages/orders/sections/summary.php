...
<header class="clearfix" style="padding-top: 60px;padding-left: 30px;padding-right: 30px;padding-right: 0">
	<div class="lfloat"><h1 style="display: inline-block;"><i class="icon-line-chart mrs"></i><span>สรุปยอดรายรับ</span></h1>
	</div>
	<div class="tar fsm mbm"><span data-summary="date"></span></div>
</header>
</div>
