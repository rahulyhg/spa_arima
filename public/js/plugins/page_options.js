...
(function( $, window, document, undefined ) {
	...
	var PageSlideshow = {
		init: function(options, elem) {
			...
			self.options = $.extend( {}, $.fn.page_options.options, options );
			...
			if( self.options.options.limit ){

				for (var i = length; i < self.options.options.limit; i++) {
					self.addItem({});
				}
			}
	...
	$.fn.page_options = function( options ) {
		return this.each(function() {
			var $this = Object.create( PageSlideshow );
			$this.init( options, this );
			$.data( this, 'page_options', $this );
		});
	};
